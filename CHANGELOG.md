...
- a few warnings and deprecations ([#1558](https://github.com/serialport/node-serialport/issues/1558)) ([a250f09](https://github.com/serialport/node-serialport/commit/a250f0983c2ca9b2b0fd5d9a00e1d88b0e8d2480))
- Add missing `return` statement ([#1911](https://github.com/serialport/node-serialport/issues/1911)) ([288e6ac](https://github.com/serialport/node-serialport/commit/288e6acd247cf223c5d29a7ae1b989272bd5e0d2))
- Add missing asyncClose ([#1946](https://github.com/serialport/node-serialport/issues/1946)) ([4a3d2a0](https://github.com/serialport/node-serialport/commit/4a3d2a017d36c519b13798b6fd479fae6c7911c7)), closes [#1904](https://github.com/serialport/node-serialport/issues/1904)
- bindings now error when closed during empty writes ([#1872](https://github.com/serialport/node-serialport/issues/1872)) ([9d01492](https://github.com/serialport/node-serialport/commit/9d014929688bc06e00f4400f66f540593cee6441))
...
- build isn't using the right version on 32x ([#1564](https://github.com/serialport/node-serialport/issues/1564)) ([f9953f2](https://github.com/serialport/node-serialport/commit/f9953f2a16cd3661fdaa5bcf3a5b2972a793aff8))
...
- **changelog:** drop the augular changelog as it misses commits ([7d0ff88](https://github.com/serialport/node-serialport/commit/7d0ff88cc9fa5965114f98f42af1a865829b6df8))
- conflicting website npm script name ([f6a800e](https://github.com/serialport/node-serialport/commit/f6a800e7593ee643f48b0980c5da18fb5b6c96a2))
- deprecated c++ functions for update to Node v12 ([#1743](https://github.com/serialport/node-serialport/issues/1743)) ([1eecd60](https://github.com/serialport/node-serialport/commit/1eecd60171a5156c635e0730f66df1dd3dea2bb6))
- deps for parser-readline need upgrading ([aa7c0b2](https://github.com/serialport/node-serialport/commit/aa7c0b2d8ef420d34e3997e434138ce5a2a258a7))
...
- **docs:** Add a note about windows support ([76b7191](https://github.com/serialport/node-serialport/commit/76b71913f49ffbafaeb040ac5eafda734cab02e2)), closes [#1299](https://github.com/serialport/node-serialport/issues/1299)
- **docs:** add missing parsers to properties list ([3faadac](https://github.com/serialport/node-serialport/commit/3faadac88af3a8111cc7412fbee151fe3448c92b))
- **docs:** correct default highWaterMark to 65536 bytes ([e83ec4e](https://github.com/serialport/node-serialport/commit/e83ec4e58523ec43ae544dee3f9e0a017b726c21))
- **docs:** Put gitter link back ([f8f3ce5](https://github.com/serialport/node-serialport/commit/f8f3ce59bb1284d1292ecfa22e5de69c563340a9))
...
- fix open colelctive link ([#1928](https://github.com/serialport/node-serialport/issues/1928)) ([6426214](https://github.com/serialport/node-serialport/commit/6426214b88ef4b9b95d31f0c80eda043fb4e8257))
- Fixed typo in upgrade guide ([#1321](https://github.com/serialport/node-serialport/issues/1321)) ([bf251a9](https://github.com/serialport/node-serialport/commit/bf251a970330952ee3d87a688e3ae44b43b7f2bf))
...
- **linux:** Adds missing header file for musl libc (eg alpine) ([#1487](https://github.com/serialport/node-serialport/issues/1487)) ([02e2bfe](https://github.com/serialport/node-serialport/commit/02e2bfecf0b32037121abb5bc2925dcb83785934)), closes [#1470](https://github.com/serialport/node-serialport/issues/1470)
- **linux:** The productID should be a number not a description string ([#1279](https://github.com/serialport/node-serialport/issues/1279)) ([bf46f68](https://github.com/serialport/node-serialport/commit/bf46f682d4c92f7eda8006d874a3639b7045f2c2)), closes [#1278](https://github.com/serialport/node-serialport/issues/1278)
- make node 12 work! ([00dc272](https://github.com/serialport/node-serialport/commit/00dc2722f73a3a281bea4547aa45e763e58a5d7d))
- memory leak in unix serialport poller ([#1572](https://github.com/serialport/node-serialport/issues/1572)) ([9006bd6](https://github.com/serialport/node-serialport/commit/9006bd61f4ee3f3c654f27c7aafdc171d34e5377))
- missing maintainer name ([a626103](https://github.com/serialport/node-serialport/commit/a626103b6894bfe66d6f46e0387fb5da6a6d5312))
- mocha opts ([e6742db](https://github.com/serialport/node-serialport/commit/e6742dbeec0cab74fade1e32e89d55dc1022f91d))
...
- npm and git ignore for prebuild ([fb565fd](https://github.com/serialport/node-serialport/commit/fb565fd345224be34080be598329c739dfaa7925))
...
- **packages/bindings#write:** do not call native binding for empty buffers ([d347f3b](https://github.com/serialport/node-serialport/commit/d347f3b8073db01b131461e59a818e5b1783283e))
- **packages:** just-extend isn't necessary anymore ([#1376](https://github.com/serialport/node-serialport/issues/1376)) ([8f650c3](https://github.com/serialport/node-serialport/commit/8f650c344e8df171562dd71470ae2843660456dc))
- **package:** update bindings to version 1.3.0 ([38606f4](https://github.com/serialport/node-serialport/commit/38606f492a5d7a803843b7e5785ca8b4b93628e2))
- **package:** update debug to version 3.0.0 ([#1292](https://github.com/serialport/node-serialport/issues/1292)) ([4987750](https://github.com/serialport/node-serialport/commit/4987750a18fd668295b57b81b003cb4a4c00709e))
...
- prebuild now pays attention to lerna tags ([#1639](https://github.com/serialport/node-serialport/issues/1639)) ([d3d553f](https://github.com/serialport/node-serialport/commit/d3d553f6c052e7de671d75adaf8faa513d6de63d))
- prebuild on mojave ([#1759](https://github.com/serialport/node-serialport/issues/1759)) ([d4f5128](https://github.com/serialport/node-serialport/commit/d4f5128026cf6b9e5beaea19316ecd2c3221cfa7)), closes [/github.com/nodejs/node/pull/23685#issuecomment-430408541](https://github.com//github.com/nodejs/node/pull/23685/issues/issuecomment-430408541)
- propagate async context in callbacks ([#1765](https://github.com/serialport/node-serialport/issues/1765)) ([9b5dbdb](https://github.com/serialport/node-serialport/commit/9b5dbdb23bbfe3148f77d6dccd0b41aa49ec0e4b)), closes [#1751](https://github.com/serialport/node-serialport/issues/1751)
- readme badges and images for backers and contributors ([#1881](https://github.com/serialport/node-serialport/issues/1881)) ([1fd88e1](https://github.com/serialport/node-serialport/commit/1fd88e1704f2742a6885c3c31c3ce3ec5e285415))
...
- Remove a new Buffer() call ([#1603](https://github.com/serialport/node-serialport/issues/1603)) ([e21fe7a](https://github.com/serialport/node-serialport/commit/e21fe7a2d1e0f1d375e07c0170ac40199b83e912))
- remove PURGE_RXABORT flag on flush for Windows ([#1817](https://github.com/serialport/node-serialport/issues/1817)) ([1daa919](https://github.com/serialport/node-serialport/commit/1daa9191a7e47c4146ae3394cb705a92d8f8d28b))
- RTS/CTS flow control for Windows ([#1809](https://github.com/serialport/node-serialport/issues/1809)) ([cd112ca](https://github.com/serialport/node-serialport/commit/cd112ca5a3a3fe186e1ac6fa78eeeb5ea7396185))
...
- stop polling if the poller has an error ([#1936](https://github.com/serialport/node-serialport/issues/1936)) ([c57b6e9](https://github.com/serialport/node-serialport/commit/c57b6e9ea9de08ddce0947a812c0d68e7f6f4b86)), closes [#1803](https://github.com/serialport/node-serialport/issues/1803)
...
- **terminal:** specifying a port now behaves correctly ([#1463](https://github.com/serialport/node-serialport/issues/1463)) ([1fa20e7](https://github.com/serialport/node-serialport/commit/1fa20e792e6708868053ed4d42e15e5b4aed84e0))
- **tests:** fixup for [#1279](https://github.com/serialport/node-serialport/issues/1279) ([#1285](https://github.com/serialport/node-serialport/issues/1285)) ([56074f6](https://github.com/serialport/node-serialport/commit/56074f606f6a98c10e6e3331564dc6bf6c0d232f))
...
- unix reading ([#1953](https://github.com/serialport/node-serialport/issues/1953)) ([c7ca08f](https://github.com/serialport/node-serialport/commit/c7ca08f03afbb58a94f39d6e481cf199d388e1a2))
...
- use correct casts to/from HANDLE/int ([#1766](https://github.com/serialport/node-serialport/issues/1766)) ([ce503b3](https://github.com/serialport/node-serialport/commit/ce503b32269aa07dc5e3038ba0ec755cd2ddaca4))
- we weren’t running all the tests ([#1937](https://github.com/serialport/node-serialport/issues/1937)) ([a5f7d60](https://github.com/serialport/node-serialport/commit/a5f7d607ea4fb609e873e6176c0af3886d736a44))
...
- **windows:** Add option to disable RTS ([#1277](https://github.com/serialport/node-serialport/issues/1277)) ([5b8d163](https://github.com/serialport/node-serialport/commit/5b8d1638610bd403d011477cd6bcf38fa55c7240))
- **windows:** Asynchronous callbacks for reading and writing ([#1328](https://github.com/serialport/node-serialport/issues/1328)) ([69de595](https://github.com/serialport/node-serialport/commit/69de5950a654498698135427c37931b15a597767)), closes [#1221](https://github.com/serialport/node-serialport/issues/1221)
- **windows:** Asynchronous callbacks for reading and writing on Windows ([#1313](https://github.com/serialport/node-serialport/issues/1313)) ([2c2a8b6](https://github.com/serialport/node-serialport/commit/2c2a8b688cdeb22076a11ebffe2543dbc3689910)), closes [#1221](https://github.com/serialport/node-serialport/issues/1221)
- **windows:** bad parameter for ReadThread (windows) ([#1377](https://github.com/serialport/node-serialport/issues/1377)) ([6f3afbe](https://github.com/serialport/node-serialport/commit/6f3afbe5a1caa4b561e124f1b7c8830c589f66c4))
- **windows:** Fix async handle leak ([#1367](https://github.com/serialport/node-serialport/issues/1367)) ([c1d9d88](https://github.com/serialport/node-serialport/commit/c1d9d88aa6cc36cb2b1f99ef8c9b1dfc0e742b5a)), closes [#1363](https://github.com/serialport/node-serialport/issues/1363)
- **windows:** Fix read & write bugs for windows ([#1364](https://github.com/serialport/node-serialport/issues/1364)) ([0e4b1f9](https://github.com/serialport/node-serialport/commit/0e4b1f9fb43a390af22bb7c05a990dfe8686a7f7))
- **windows:** Parse more types of pnpIds ([#1288](https://github.com/serialport/node-serialport/issues/1288)) ([0b554d7](https://github.com/serialport/node-serialport/commit/0b554d7368364bbb937d9370f8d670d999a2cbbc)), closes [#1220](https://github.com/serialport/node-serialport/issues/1220)
- **windows:** Reset Buffer after write operations are complete to free memory ([#1547](https://github.com/serialport/node-serialport/issues/1547)) ([a1eef11](https://github.com/serialport/node-serialport/commit/a1eef112d6406d45d230b1f48c84938dcd652709))
- writing issue on Linux ([#1908](https://github.com/serialport/node-serialport/issues/1908)) ([a7d1937](https://github.com/serialport/node-serialport/commit/a7d1937f376f81977a96794a015afc2004eb8c3c))

### chore

- **binaries:** Lets switch to prebuild! ([#1282](https://github.com/serialport/node-serialport/issues/1282)) ([8c36e99](https://github.com/serialport/node-serialport/commit/8c36e99694837ce970150c80a623eecd2b71df6f))
...
- Added packet timeout for cctalk parser ([#1887](https://github.com/serialport/node-serialport/issues/1887)) ([714e438](https://github.com/serialport/node-serialport/commit/714e438c25141aaedcfca5ac2ffa382e628b4c11))
...
- **docs:** Switch to JSDOC docs not in the readme ([#1383](https://github.com/serialport/node-serialport/issues/1383)) ([60fc047](https://github.com/serialport/node-serialport/commit/60fc0472891d1ec642f83665a41937d996b5d369))
...
- generators for new packages ([#4](https://github.com/serialport/node-serialport/issues/4)) ([94ede44](https://github.com/serialport/node-serialport/commit/94ede443c22ce75f9df2ceeaaebf676d96c3f784))
...
- inter byte timeout parser ([#1779](https://github.com/serialport/node-serialport/issues/1779)) ([cbb8e41](https://github.com/serialport/node-serialport/commit/cbb8e41315ddaacca5ba4f43609e40eb01d4cfd0))
...
- **linter:** Added 'cc' to lint the C++ code on 'npm lint' ([#1501](https://github.com/serialport/node-serialport/issues/1501)) ([59960a3](https://github.com/serialport/node-serialport/commit/59960a39208d0f56a82a7ad90c3ed9e10e9106c2))
- **linux:** Custom baud rates for linux (eg 250k baudrate) ([#1464](https://github.com/serialport/node-serialport/issues/1464)) ([910438c](https://github.com/serialport/node-serialport/commit/910438c2ca349a717eb45b00b7576e908b1d1aeb))
- Make it possible to compile on vanilla Android ([#1912](https://github.com/serialport/node-serialport/issues/1912)) ([ba2b69c](https://github.com/serialport/node-serialport/commit/ba2b69c4f4f3e6fbf9b59cdf450c696400435587))
...
- namespace all packages in the new serialport npm org! ([b722062](https://github.com/serialport/node-serialport/commit/b722062f3c174f2363bfaee77ebbd686b114703d))
...
- **open:** Throw on incorrect baudrate option ([#1347](https://github.com/serialport/node-serialport/issues/1347)) ([a3b8d35](https://github.com/serialport/node-serialport/commit/a3b8d3559771eafcc2f11ca58618bd68fb7344a4))
- **parsers:** Add cctalk parsers ([#1342](https://github.com/serialport/node-serialport/issues/1342)) ([bcb492f](https://github.com/serialport/node-serialport/commit/bcb492f3869d53425778b610d31efc2cd46063c8))
- **parsers:** Adding option to include delimiter in the DelimiterParser transform. ([#1453](https://github.com/serialport/node-serialport/issues/1453)) ([6a3ab65](https://github.com/serialport/node-serialport/commit/6a3ab65f09a76284396a21dd78a8b16d53b0b2c1))
- **parsers:** ByteLength is now more efficient ([#1402](https://github.com/serialport/node-serialport/issues/1402)) ([f7eb2f0](https://github.com/serialport/node-serialport/commit/f7eb2f0df4317191afa3a95a5ac8bbed4ec49344))
...
- reset info.serialNumber when resetting mock ports ([#1899](https://github.com/serialport/node-serialport/issues/1899)) ([6acaac1](https://github.com/serialport/node-serialport/commit/6acaac15b5ecce6d68cd94ff608c9b0880928108))
- support Exar ttyXRUSB ([#1893](https://github.com/serialport/node-serialport/issues/1893)) ([3d34d0f](https://github.com/serialport/node-serialport/commit/3d34d0f7c06009bf256a4af0f306d3a2e30b3bf6))
...
- Test merges with master ([#1952](https://github.com/serialport/node-serialport/issues/1952)) ([bfb47c7](https://github.com/serialport/node-serialport/commit/bfb47c71dac11fcb0b164b3b9768543bff38873b))
- test on node 12 ([#1846](https://github.com/serialport/node-serialport/issues/1846)) ([46da21f](https://github.com/serialport/node-serialport/commit/46da21f55a80d152a190b669eb00d4b3d3db1fc0))
- **test:** tone down codecov comments ([#1289](https://github.com/serialport/node-serialport/issues/1289)) ([749ffac](https://github.com/serialport/node-serialport/commit/749ffacd536867697c0a3644e1cb7eb6f240daea))
...
- upgrade socket-io example to latest serialport and fix bug ([#1505](https://github.com/serialport/node-serialport/issues/1505)) ([86e5ab0](https://github.com/serialport/node-serialport/commit/86e5ab00e2d8d16a1c66570e2094a494422ce308))
- Use GitHub actions for linting ([#1927](https://github.com/serialport/node-serialport/issues/1927)) ([fb05c2d](https://github.com/serialport/node-serialport/commit/fb05c2d80f8219ee41d597a43381ecb8134ea5b9))
- use lerna run! ([#1643](https://github.com/serialport/node-serialport/issues/1643)) ([7b37a36](https://github.com/serialport/node-serialport/commit/7b37a3660c7a72b4865914629c88685e257da3b8))
- **windows:** Add ERROR_INVALID_PARAMETER to supported bindings errors ([#1354](https://github.com/serialport/node-serialport/issues/1354)) ([4ff9c67](https://github.com/serialport/node-serialport/commit/4ff9c67dc4ac86c49395d01c7f157ba9fb9b81ad))
- **windows:** Fetch USB serial number by lookups in win registry ([#1483](https://github.com/serialport/node-serialport/issues/1483)) ([45b3a2f](https://github.com/serialport/node-serialport/commit/45b3a2feb5c1b7e4464638e1be7635d28881fa46)), closes [#1459](https://github.com/serialport/node-serialport/issues/1459)
...
- Revert "fix(windows): Asynchronous callbacks for reading and writing on Windows" (#1323) ([c7a3be4](https://github.com/serialport/node-serialport/commit/c7a3be416461d065b260a0710de1b8d25d97b052)), closes [#1323](https://github.com/serialport/node-serialport/issues/1323)
- Revert "Add BREAK command, useful for CISCO router to break into rommon" ([b428c3d](https://github.com/serialport/node-serialport/commit/b428c3d940cd38a943b285c04e5a27245f80fc40))
